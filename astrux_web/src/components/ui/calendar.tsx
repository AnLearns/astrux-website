        ...
        <DayPicker
            ...
            classNames={{
                ...
                day: cn(
                    ...
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-zinc-300 hover:text-white hover:bg-white/10"
                ),
                ...
                day_outside:
                    "day-outside text-zinc-700 aria-selected:bg-white/5 aria-selected:text-zinc-500",
                day_disabled: "text-zinc-700 opacity-50",
                day_range_middle:
                    "aria-selected:bg-white/5 aria-selected:text-zinc-300",
